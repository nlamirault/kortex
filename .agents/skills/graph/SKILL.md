...
Structured-query variant of Operation 2. Traverses `## Relations` SPO tables to
answer connection queries without reading full page text — the graph over the
synthesized layer. Provenance format mandated by
