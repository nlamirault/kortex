...
Domain seeding operation. Creates a hub + seed concepts so a new topic area has a
scaffold before real sources arrive — the wiki's cold-start path. Provenance format
mandated by [[decision:adopt-wikiskill-evolution-loop]].
