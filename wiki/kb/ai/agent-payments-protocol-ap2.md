...
description: The **Agent Payments Protocol (AP2)** is an open standard designed to enable artificial intelligence (AI) agents to perform payments securely and interoperably, especially in scenarios where the user is not physically present. It extends the **Agent2
tags: ["AI", "Protocol"]
timestamp: 2026-08-17T08:18:00Z
---
...
![ap2_graphic.png](Explanation%20Agent%20Payments%20Protocol%20(AP2)/ap2_graphic.png)
