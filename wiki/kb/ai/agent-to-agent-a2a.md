...
description: **A2A (Agent-to-Agent)** is a communication protocol enabling **autonomous agents** to **interact, collaborate, or negotiate** with each other in a structured, interoperable way. It is often used in **multi-agent systems (MAS)**, **cognitive architec
tags: ["AI", "Protocol"]
