...
type: Explanation
title: Blockchain
description: A **blockchain** is a **distributed, append-only database**, structured as a sequence of **cryptographically linked blocks**, and replicated across a **peer-to-peer (P2P) network**.
tags: ["Architecture", "Blockchain"]
timestamp: 2025-08-27T17:13:00Z
---
