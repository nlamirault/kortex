...
description: **Change Data Capture (CDC)** is a technique used to **track and capture changes (inserts, updates, deletes)** made to a database so that downstream systems can react to those changes in near real-time or batch mode.
tags: ["Database"]
timestamp: 2025-05-19T17:32:00Z
---
