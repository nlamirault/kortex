...
type: Explanation
title: Keda
description: KEDA (Kubernetes Event-Driven Autoscaling) is an open-source project that enables event-driven scaling in Kubernetes. It extends Kubernetes' native **Horizontal Pod Autoscaler (HPA)** to allow applications to scale **based on external event sources**
