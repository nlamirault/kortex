...
type: Reference
title: FOCUS
description: FinOps Open Cost and Usage Specification (FOCUS) is an open-source standard developed to streamline the way cloud billing data is formatted and handled across multiple cloud platforms. As a technical specification, FOCUS mandates a unified format for
tags: ["FinOps"]
...
![focus-img.webp](Reference%20FOCUS/focus-img.webp)
