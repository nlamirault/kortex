...
type: Explanation
title: Loki
description: Grafana Loki is a horizontally scalable, highly available, multi-tenant log aggregation system inspired by Prometheus. It is designed to be very cost-effective and easy to operate, as it does not index the contents of the logs, but rather a set of la
tags: ["Logging", "Observability", "OpenTelemetry"]
timestamp: 2025-02-28T11:02:00Z
---
...
![napkin-selection (8).png](Explanation%20Loki/napkin-selection_(8).png)
