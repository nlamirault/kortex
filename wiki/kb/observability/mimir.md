...
type: Explanation
title: Mimir
description: Grafana Mimir is an open-source, highly scalable, and operationally simple long-term storage for Prometheus. Mimir provides long-term storage, querying, and horizontal scalability for Prometheus metrics.
