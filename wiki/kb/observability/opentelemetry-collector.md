...
description: OpenTelemetry Collector is an open-source, unified agent that collects distributed traces, metrics, and logs using standard formats. It is built by the Cloud Native Computing Foundation (CNCF) as part of the OpenTelemetry project.
