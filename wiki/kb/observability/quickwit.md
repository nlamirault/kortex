...
type: Explanation
title: Quickwit
description: Quickwit is an open-source, distributed search engine designed for large-scale datasets such as logs and events. It is built with a focus on cost-efficiency and is optimized for large-scale indexation and searches.
