...
type: Explanation
title: Tempo
description: Grafana Tempo is an open-source, high-volume, and minimal-dependency distributed tracing backend. It is designed to be a robust and cost-effective solution for storing and querying massive amounts of trace data.
