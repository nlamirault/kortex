...
type: Reference
title: VEX
description: **VEX** is a **standardized format** (usually in JSON or XML) used by organizations to **share context around whether a specific vulnerability actually applies to their product or environment**.
